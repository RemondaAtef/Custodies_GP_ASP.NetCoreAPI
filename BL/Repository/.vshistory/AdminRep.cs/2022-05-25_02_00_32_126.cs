...
namespace DB3GP.BL.Repository
{
    public class AdminRep : IAdminRep
    {
        ...
        public IEnumerable<Item> getAlldata()    //done
        {
            var data = db.Item;
        ...
        public IEnumerable<getAllUsersVM> getAllUsers()
        {
        ...
        //public Item AddItem(string itemName, string itemType, string serial, int quantity, int price)
        //{
        //    var data = Search(itemName);
        //    if (itemName != null && number == 0 && password == null && confirmpassword == null)
        //    {
        //        data.Name = name;
        //        db.User.Update(data);
        //        db.SaveChanges();
        //    }
        //    else if (itemName != null && number != 0 && password == null && confirmpassword == null)
        //    {
        //        data.Name = name;
        //        data.Number = number;
        //        db.User.Update(data);
        //        db.SaveChanges();
        //    }
        //    else if (name != null && number != 0 && password != null && confirmpassword != null)
        //    {
        //        data.Name = name;
        //        data.Number = number;
