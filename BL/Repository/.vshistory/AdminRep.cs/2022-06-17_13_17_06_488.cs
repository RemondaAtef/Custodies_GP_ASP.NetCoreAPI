    ...
    public class AdminRep : IAdminRep
    {
        ...
        public Item AddExistItemF(string name, int QT)   //Add Exist Item : Furniture
        {
            ...
            var data = db.Item.Where(a => a.ItemName == name && a.ItemType == "Furniture" )
                                 .Select(a => new Item { ItemId = a.ItemId, ItemName = a.ItemName, Quantity = a.Quantity + QT, UnitPrice = a.UnitPrice, Serial = a.Serial, ItemType = a.ItemType , DateUpdated = DateTime.Now})
                                  .FirstOrDefault();
