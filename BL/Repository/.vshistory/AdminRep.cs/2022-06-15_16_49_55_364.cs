...
namespace DB3GP.BL.Repository
{
    public class AdminRep : IAdminRep
    {
        ...
        public Request UpdateDatabase(string requestStatus, string userid)
        {
            ...
            {
                //data.RequestStatus = "Owned";
                //db.Request.Update(data);
                //db.SaveChanges();
        ...
        public void UpdateDatabase3(string requestStatus, string userid)
        {
           var d1 =  UpdateDatabase(requestStatus , userid);
            ...
            //Item I = new Item();
            //if ( I.ItemType == "Furniture" )
            //{
            d1.RequestStatus = "Owned";
            db.Request.Update(d1);
            db.SaveChanges();
            ...
            var data1 = db.Item.Where(a => a.ItemType == "Electronic Device")
                                     .Select(a => new Item { ItemId = a.ItemId, ItemName = a.ItemName, ItemType = a.ItemType, ItemStatus = d1.RequestStatus, Image = a.Image, Popular = a.Popular, Serial = a.Serial, UnitPrice = a.UnitPrice, DateUpdated = DateTime.Now, Quantity = a.Quantity })
                                     .FirstOrDefault();
