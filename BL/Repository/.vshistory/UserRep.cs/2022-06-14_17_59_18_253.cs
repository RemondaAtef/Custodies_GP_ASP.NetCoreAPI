...
namespace DB3GP.BL.Repository
{
    public class UserRep : IUserRep
    {
        ...
        public AddToCartVM AddExisttoCart(AddToCartVM dpt)   //Add exist item to my cart by userID ,  ItemID
        {

            //var data = db.Cart.Where(a => a.UserId == userid && a.ItemId == itemid)
            //                      .Select(a => new AddToCartVM { CartID = a.CartID, ItemId = a.ItemId, UserId = a.UserId, Quantityy = a.CartQuantity + 1 })
            //                      .FirstOrDefault();
            Cart d = new Cart();
            d.CartQuantity = d.CartQuantity + 1;
