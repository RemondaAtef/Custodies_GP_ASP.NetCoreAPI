...
namespace DB3GP.BL.Repository
{
    public class UserRep : IUserRep
    {
        ...
        //public IEnumerable<ItemNamePhoto> Login(string email , string password)
        //{
        //    //var data = db.Member.Where(a => a.Email == email && a.Password == password)
        //    //   .Select(a => new Member { Name = a.Name, Email = a.Email })
        //    //.Select(b => new ItemNamePhoto() { ItemName = b.ItemName, Image = b.Image })
        //    //.FirstOrDefault();
        ...
        //    //}
        //    //return dpt;
        //    var data = PopularItems();
        //    Member m = new Member();
        //    signin dpt = new signin();
        //    if (m.Email != dpt.email || m.Password != dpt.Password)
        //    {
        //        Console.WriteLine("Error");
        //    }
