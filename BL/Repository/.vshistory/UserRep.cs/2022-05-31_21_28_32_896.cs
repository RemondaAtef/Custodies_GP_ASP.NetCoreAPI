...
namespace DB3GP.BL.Repository
{
    public class UserRep : IUserRep
    {
       ...
       public void RequestToRestore(string userid, string statusAfterRestore)
        {
        ...
        public IEnumerable<ShowMyOwnershipVM> ShowMyOwnership(string userid)   //Show myOwnerShip by userID
        {
            var data = db.OwnerShip.Where(a => a.UserId == userid)
                .Select(a => new ShowMyOwnershipVM() { ownershipid = a.OwnerShipID,ItemName = a.Item.ItemName, Date = a.OwnershipDate});
