    ...
    public class DbContainer : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Request>()
                .HasData(new Request { RequestID = 1000, UserId = "5e844823-8fba-428c-8161-5b04e29wue12", ItemId = 7021, RequestQuantity = 1, TakeOrRestore = "Take" },
                new Request { RequestID = 10001, UserId = "5e844823-8fba-428c-8161-5b04e29wue12", ItemId = 7030, RequestQuantity = 1, TakeOrRestore = "Restore" });

            modelBuilder.Entity<Cart>()
                .HasData(new Cart { CartID = 5001, ItemId = 7035, UserId = "5e844823-8fba-428c-8161-5b04e29wue12" },
                new Cart { CartID = 5002, ItemId = 7020, UserId = "5e844823-8fba-428c-8161-5b04e29wue12", CartQuantity = 3 });
