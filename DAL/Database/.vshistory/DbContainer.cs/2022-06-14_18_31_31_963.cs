    ...
    public class DbContainer : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Request>()
                .HasData(new Request { RequestID = 1000, UserId = "5e844823-8fba-428c-8161-5b04e29wue12", ItemId = 1 , RequestQuantity = 1 , RequestStatus = "Take"},
                new Request { RequestID = 10001, UserId = "5e844823-8fba-428c-8161-5b04e29wue12", ItemId = 5, RequestQuantity = 1, RequestStatus = "Restore" });
